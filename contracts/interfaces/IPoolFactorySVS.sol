...
/**
 * @title IPoolFactorySVS
 * @author Souq.Finance
 * @notice Defines the interface of the factory for SVS pools
 * @notice License: https://souq-exchange.s3.amazonaws.com/LICENSE.md
 */

interface IPoolFactorySVS {
    /**
     ...
     */
    function deployPool(DataTypes.PoolSVSData memory poolData, string memory symbol, string memory name) external returns (address);
